...
// Używamy cdn.jsdelivr.net, aby zapewnić poprawne nagłówki i uniknąć limitów rate-limit GitHub API.
$url = 'https://cdn.jsdelivr.net/gh/QubaPra/huraganGra@master/index.html';
...
if ($html_content !== false) {
    ...
    $base_tag = "\n    <base href=\"https://cdn.jsdelivr.net/gh/QubaPra/huraganGra@master/\">\n";
